  ...
  render() {
    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        ...
        <h1 className="text-3xl font-bold mt-8">{post.frontmatter.title}</h1>
        <p className="mt-3.5 mb-8">
          {post.frontmatter.date} {', ☕️ '} {post.frontmatter.time}{' '}
          {' min read'}
        </p>
        <div
        ...
        <div
          async
          data-uid="4b025950f8"
          src="https://fabulous-trader-9105.ck.page/4b025950f8/index.js"
        ></div>
      </Layout>
    )
  }
